...
export const services = [
  { id: 'consulting', name: 'Business Consulting', icon: 'consulting', short: 'Local understanding for your next business decision.', text: 'Practical guidance and access to relevant market expertise for companies considering opportunities, partnerships or development between the Polish and Israeli markets.', topic: 'Market Entry' },
  { id: 'partner-search', name: 'Business Partners', icon: 'search', short: 'Find people and organisations aligned with your objective.', text: 'Identification of potential companies and organisations relevant to a specific commercial objective.', topic: 'Business Partner Search' },
  ...
  { id: 'specialist', name: 'Legal Support', icon: 'gdpr', short: 'Access legal guidance for cross-border activity.', text: 'Access to relevant legal contacts and support connected with international business activity.', topic: 'Legal Support' },
];
...
export const innovation = [
  ['International connections', 'Introductions to companies, institutions and NGOs.', 'network'],
...
export const topics = ['Business Partner Search', 'Market Entry', 'Business Meeting', 'Business Mission', 'International Project', 'Legal Support', 'Startup / Innovation', 'Investor Connection', 'Institutional Contact', 'Other'];
