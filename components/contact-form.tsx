...
export function ContactForm(){
 ...
 return <div data-reveal="right"><div className="form-intro"><h2>Your business objective</h2><span>* Required fields</span></div><form className="contact-form" ref={form} onSubmit={submit}>
